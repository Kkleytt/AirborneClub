...
Ближайщий план обновлений на 6 месяцев:
	1. Возможность любое сообщение оставлять в чате (закреплять)
	2. Добавление функции отслеживания трафика пользователей
	3. Добавление функции блокировки пользователей
	4. Добавление функции выдачи прав пользователям
	5. Добавление функций тестирования бота (Интернет, пинг, настройки доступа)
	6. Добавление функций отслеживания результатов тестирования (Неверные ответы, результаты тестирования)
	7. Связка бота тестов с главным ботом
